...
knitr::include_graphics(path = "session3_workflow_files/figures/git_github.png")
```
...
knitr::include_graphics(path = here("static/media/teaching_materials/workflow/session3_workflow_files/figures/github_overview.png"))
```
...
knitr::include_graphics(path = here("static/media/teaching_materials/workflow/session3_workflow_files/figures/overleaf.png"))
```
