...
knitr::include_graphics(here("static/media/teaching_materials/session1_slides_files/figs/mobile_usage_prediction_map_nigeria.png"))
```
...
knitr::include_graphics(here("static/media/teaching_materials/session1_slides_files/figs/rstudio_layout.png"))
```
...
knitr::include_graphics(here("static/media/teaching_materials/session1_slides_files/figs/quarto_doc.png"))
...
knitr::include_graphics(here("static/media/teaching_materials/session1_slides_files/figs/lightbulb_analogy.png"))
```
:::
:::::
...
censoc <- read_csv(here("static/media/data/censoc_numident_demo_v2.1.csv"))
```
...
knitr::include_graphics(here("static/media/teaching_materials/session2_slides_files/figs/tidyverse_fig.png"))
```
:::
:::::
