...
knitr::include_graphics(
  here::here("static/media/teaching_materials/session3_workflow/session3_workflow_files/figures/github_overview.png")
)
```
...
-   Version control helps track changes to code; easy to revert if you
    made a mistake
...
knitr::include_graphics(path = here("static/media/teaching_materials/session3_workflow/session3_workflow_files/figures/github_overview.png"))
```
...
Send ("push") your changes up to remote repository (where collaborators
/ public can see)
...
-   **Branches**: Isolated enviroment for development, merge back in
    with man codebase when you're ready

## Link to Open Science Framework repository

-   Create public GitHub repository with replication code + instructions
    for a mansucript
...
-   Latex is a high-quality typesetting system for writing scientific
    documents
...
knitr::include_graphics(
  here::here("static/media/teaching_materials/session3_workflow/session3_workflow_files/figures/overleaf.png")
)
```
...
-   [Beamer
    Slides](https://www.overleaf.com/2727944419gdndkvrssnyp#0edad9)

-   [Latex
    Manuscript](https://www.overleaf.com/9127815783ypcnhppssxxd#c7eac7)
...
-   Markdown is simpler than Latex, but fewer features / less resources
    for help
...
-   [Zotero connector](https://www.zotero.org/download/connectors):
    browser plug-in the automatically add and pdf paper to a collection

-   [Better Bibtex](https://retorque.re/zotero-better-bibtex/): help
    customize the different citation keys
...
2.  Add 3 papers to the new collection (use Zotero connector or drag in
    PDFs)
...
-   Zotero: [Getting Started with
    Zotero](https://library-guides.ucl.ac.uk/zotero)
